...
if (!jsonPathArg) {
  console.error('Usage: node node/json-to-embed-player.js <input.json> [output.js]');
  process.exit(1);
}
...
const outputPath = path.resolve(
  outputPathArg || `${path.basename(inputPath, path.extname(inputPath))}.embed.js`
);
